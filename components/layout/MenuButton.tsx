...
export const MenuButton = ({ isOpen, toggle }: { isOpen: boolean; toggle: () => void }) => {
  ...
  return (
    <button 
      onClick={toggle} 
      className="p-2 text-foreground focus:outline-none focus:ring-2 focus:ring-brand-accent/40 rounded-lg relative z-50 w-10 h-10 flex flex-col justify-center items-center gap-1" 

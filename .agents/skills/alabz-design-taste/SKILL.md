...
Se o workspace possuir o arquivo `design-system/MASTER.md` (gerado previamente na inicialização com a skill `ui-ux-pro-max`), você DEVE ler e consumir os tokens de cores exatos, tipografias e atmosfera contidos nele como a Fonte Única da Verdade para as definições de estilo visual.

Se o workspace tiver uma biblioteca visual local, leia-a antes de definir o sistema final:

- `design-system/MASTER.md` (Gerado pela skill ui-ux-pro-max - Prioridade Máxima)
